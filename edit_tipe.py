...
Tipe {submodules.ch_color_style(tipe_dihapus, "blue")} dari {submodules.ch_color_style(dari, "blue")}""")
        ...
        # Pilihan menu edit batas presentase pengeluaran
            ...
            pilih_label = submodules.input_of_int_options(f"Input nomor tipe pengeluaran ({byk_tipe1+1}-{byk_tipe1+byk_tipe2}) yang ingin diganti batas presentase pengeluaran ", list(range(byk_tipe1+1,byk_tipe1+byk_tipe2+1)) )
